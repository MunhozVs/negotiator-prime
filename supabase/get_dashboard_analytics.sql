...
REVOKE ALL ON FUNCTION public.get_dashboard_analytics(TEXT, TIMESTAMPTZ, TIMESTAMPTZ)
  FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_dashboard_analytics(TEXT, TIMESTAMPTZ, TIMESTAMPTZ)
  TO service_role;
